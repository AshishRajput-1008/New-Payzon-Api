...
import integration_image_1 from "@/public/assets/images/avatar/integration8.png";
  ...
  return (
    <section className="ps_pntegrating_section section_space pb-0 section_decoration">
      <div className="container">
        <HeadingBlock
          badge="Integrating"
          title="Our popular Payzon API Integration"
        />

        <div className="row justify-content-center">
          <div className="col-lg-10">
            <div className="integrating_image text-center">
